...
export function mapConfigToDatabaseRecord(config: SheetTemplateConfig) {
  return {
    ...
    align_report_title: config.alignReportTitle || 'center',
    align_header_subtitle: config.alignHeaderSubtitle || 'center',
    align_procedure_ref: config.alignProcedureRef || 'center',
    align_section_titles: config.alignSectionTitles || 'left',
    align_table_headers: config.alignTableHeaders || 'center',
    cell_padding_vertical: config.cellPaddingVertical || 6,
    cell_padding_horizontal: config.cellPaddingHorizontal || 8,
    line_height_multiplier: config.lineHeightMultiplier || 1.4,
    table_border_width: config.tableBorderWidth || 2,
...
export function mapDatabaseRecordToConfig(record: any): SheetTemplateConfig {
  ...
  return {
    ...
    alignReportTitle: record.align_report_title || DEFAULT_TEMPLATE_CONFIG.alignReportTitle,
    alignHeaderSubtitle: record.align_header_subtitle || DEFAULT_TEMPLATE_CONFIG.alignHeaderSubtitle,
    alignProcedureRef: record.align_procedure_ref || DEFAULT_TEMPLATE_CONFIG.alignProcedureRef,
    alignSectionTitles: record.align_section_titles || DEFAULT_TEMPLATE_CONFIG.alignSectionTitles,
    alignTableHeaders: record.align_table_headers || DEFAULT_TEMPLATE_CONFIG.alignTableHeaders,
    cellPaddingVertical: record.cell_padding_vertical ? Number(record.cell_padding_vertical) : DEFAULT_TEMPLATE_CONFIG.cellPaddingVertical,
    cellPaddingHorizontal: record.cell_padding_horizontal ? Number(record.cell_padding_horizontal) : DEFAULT_TEMPLATE_CONFIG.cellPaddingHorizontal,
    lineHeightMultiplier: record.line_height_multiplier ? Number(record.line_height_multiplier) : DEFAULT_TEMPLATE_CONFIG.lineHeightMultiplier,
    tableBorderWidth: record.table_border_width ? Number(record.table_border_width) : DEFAULT_TEMPLATE_CONFIG.tableBorderWidth,
